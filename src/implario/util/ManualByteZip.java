...
public class ManualByteZip {
	...
	public ManualByteZip add(List<String> list){
		add(Converter.merge(list, str -> str,(char)0x0b + ""));
		return this;
	}

	public ManualByteZip addASCII(String str){
	...
	public ManualByteZip add(String str){
		add(str.getBytes(Charset.forName("UTF-8")));
		return this;
	}

	public ManualByteZip add(long l){
	...
	public ManualByteZip add(int i){
	...
	public ManualByteZip add(boolean b){
		add(b ? 0b1 : 0b0);
		return this;
	}

	public ManualByteZip add(byte b){
		add(new byte[]{b});
		return this;
	}
	...
	public ManualByteZip addStart(byte b[]){
		bytes.add(0, b);
		return this;
	}
